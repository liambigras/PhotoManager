...
namespace PhotoManager.Controllers
{
    ...
    public class PhotosController : Controller
    {
        ...
        {
            Models.Photo photos = DB.Photos.Get(id);
            return new JsonResult { Data = photos, JsonRequestBehavior = JsonRequestBehavior.AllowGet };
        }
        ...
        public ActionResult Delete(int id)
        {
            // TODO
            bool status = false;
            Models.Photo photo = DB.Photos.Get(id);
            if(photo != null)
            {
                bool error = false;
                try
